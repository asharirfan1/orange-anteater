                            ...
                            <div class="col-12 d-flex align-items-center">
                                ...
                                <label class="form-switch">
                                    <input type="checkbox" name="paytack_enable"
                                           class="form-check-input paystack-enable"
                                ...
                                <div class="col-12 d-flex align-items-center">
                                    ...
                                    <label class="form-switch">
                                        <input type="checkbox" name="fatoorah_enable"
                                               ...
                                               value="1"
                                               {{ !empty($setting['fatoorah_enable']) == '1' ? 'checked' : '' }}
                                               id="fatoorahEnable">
                                        <span class="custom-switch-indicator"></span>
                                    </label>
                                </div>
                                <div
                                    class="fatoorah-div {{ !empty($setting['fatoorah_enable']) == '1' ? '' : 'd-none' }} col-12">
                                    <div class="row">
                                        <div class="form-group col-sm-6 mb-5">
                                            {{ Form::label('fatoorah_api_key', __('messages.setting.fatoorah_api_key') . ':', ['class' => 'form-label']) }}
                                            {{ Form::text('fatoorah_api_key', isset($setting['fatoorah_api_key']) ? $setting['fatoorah_api_key'] : null, ['class' => 'form-control  myFatoorah_key ', 'placeholder' => __('messages.setting.fatoorah_api_key')]) }}
                                        </div>
